                  ...
                  ListView(
                    ...
                    children: [
                      ...
                      FilterChipGroup<int>(
                        ...
                        selected: comunasSeleccionadas,
                        onToggle: (n) => setDrawer(
                          () => comunasSeleccionadas.contains(n)
                              ? comunasSeleccionadas.remove(n)
                              : comunasSeleccionadas.add(n),
                        ),
                        labelBuilder: (n) => '$n',
                        useGrid: true,
                        gridColumns: 4,
                      ...
                      FilterChipGroup<String>(
                        items: _franjas,
                        selected: franjasSeleccionadas,
                        onToggle: (f) => setDrawer(
                          () => franjasSeleccionadas.contains(f)
                              ? franjasSeleccionadas.remove(f)
                              : franjasSeleccionadas.add(f),
                        ),
                        labelBuilder: (f) => f,
                      ...
                      FilterChipGroup<String>(
                        ...
                        onToggle: (t) => setDrawer(
                          () => tiposSeleccionados.contains(t)
                              ? tiposSeleccionados.remove(t)
