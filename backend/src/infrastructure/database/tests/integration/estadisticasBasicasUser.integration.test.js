...
describe('HU-11 ReportRepositoryImpl integración', () => {
  let repository;
  ...
  test('CP-HU11-08 periodo sin reportes devuelve total 0 y estructura valida', async () => {
    mockSupabase.from.mockReturnValueOnce(
      createChainableThenable({ data: [], error: null })
    );
